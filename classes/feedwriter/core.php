 ...
 */
abstract class Feedwriter_Core
{
    private $channels = [];  // Collection of channel elements
    private $items = [];  // Collection of items as object of Feedwriter_Item class.
    ...
    /**
     * Create a new Feedwriter_Item.
     *
     * @access   public
     * @return   object  instance of Feedwriter_Item class
     */
    public function createNewItem()
    {
        $Item = new Feedwriter_Item($this->version);

        return $Item;
    }

    /**
     * Add a Feedwriter_Item to the main class
     *
     * @access   public
     * @param    object  instance of Feedwriter_Item class
     * @return   void
     */
    public function addItem(Feedwriter_Item $feedItem)
    {
    ...
    private function makeNode($tagName, $tagContent, $attributes = null)
    {
        ...
        if (is_array($tagContent)) {
            ...
            $nodeText .= (in_array($tagName,
                $this->CDATAEncoding)) ? $this->sanitizeCDATA($tagContent) : htmlspecialchars($tagContent);
        }
